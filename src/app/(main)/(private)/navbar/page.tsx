        ...
        <Toolbar className="bg-[#111827]">
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } }}>
            <IconButton
              ...
              color="inherit"
            >
              {/* boton de mensajes recibidos */}
              <Badge badgeContent={400} color="error">
                <MailIcon />
              </Badge>
            </IconButton>

            {/* menu o boton de notificaciones */}
            <IconButton
              size="large"
              aria-label="show 17 new notifications"
              color="inherit"
            >
              <Badge badgeContent={220} color="error">
                <NotificationsIcon />
              </Badge>
            </IconButton>

            {/* boton de perfil en el menu */}
            <IconButton
              size="large"
              edge="end"
              aria-label="account of current user"
          ...
          {/* boton para cuando sea movil se despliegue menu movil */}
